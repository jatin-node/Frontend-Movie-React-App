...
const MovieDetails = () => {
  ...
  return info ? (
    <div
      style={{
        background: `linear-gradient(rgba(0,0,0,0.9), rgba(0,0,0,0.3), rgba(0,0,0,.9)), url(https://image.tmdb.org/t/p/original/${info.detail.backdrop_path})`,
        ...
        <div className="content ml-[5%] text-white max-w-full">
          ...
          <h1 className="text-5xl font-black text-white">
            ...
            <small className="text-2xl font-bold text-zinc-100">
              (
              {
                (info.detail.release_date || info.detail.first_air_date).split(
                  "-"
                )[0]
              }
              )
          ...
          {/* Description */}
          <div className="mt-3 mb-5 flex items-center text-white gap-x-5">
